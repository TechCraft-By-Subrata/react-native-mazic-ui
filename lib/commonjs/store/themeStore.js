...
exports.useTcbsColorStore = exports.defaultScaleTokens = void 0;
const zustand_1 = require("zustand");
const react_native_1 = require("react-native");
const ReactNativeMMKV = __importStar(require("react-native-mmkv"));
...
exports.useTcbsColorStore = (0, zustand_1.create)((set, get) => {
    var _a;
    ...
    const getThemeColors = (theme, colors) => {
        ...
        if (theme === 'light' || theme === 'dark') {
            ...
            const colorScheme = ((_a = react_native_1.Appearance.getColorScheme) === null || _a === void 0 ? void 0 : _a.call(react_native_1.Appearance)) || 'light';
    ...
    if (initialTheme === 'system' && !appearanceListener) {
        appearanceListener = (_a = react_native_1.Appearance.addChangeListener) === null || _a === void 0 ? void 0 : _a.call(react_native_1.Appearance, ({ colorScheme }) => {
            set((state) => ({
    ...
    return {
        ...
        scaleTokens: exports.defaultScaleTokens,
        ...
        setTcbsScale: (tokens) => {
            set((state) => ({
                scaleTokens: {
                    spacing: Object.assign(Object.assign({}, state.scaleTokens.spacing), (tokens.spacing || {})),
                    radius: Object.assign(Object.assign({}, state.scaleTokens.radius), (tokens.radius || {})),
                    fontSize: Object.assign(Object.assign({}, state.scaleTokens.fontSize), (tokens.fontSize || {})),
                },
            }));
        },
