...
const CardBody = ({ title, description, trailingIcon, theme, scaleTokens, textStyle, }) => (react_1.default.createElement(react_1.default.Fragment, null,
    ...
    react_1.default.createElement(react_native_1.View, { style: styles.content },
        ...
        trailingIcon ? (react_1.default.createElement(ionicons_1.Ionicons, { name: trailingIcon, size: scaleTokens.fontSize.xl, color: theme.textPrimary, style: [styles.icon, { marginLeft: scaleTokens.spacing.l }] })) : null)));
const CustomCard = ({ title, description, variant = 'default', style, textStyle, onPress, secureText = null, secureStrapColor = null, accessibilityLabel, accessibilityRole, accessible, trailingIcon = 'chevron-forward', }) => {
    ...
    const cardContent = (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(CardBody, { title: title, description: description, trailingIcon: trailingIcon, theme: theme, scaleTokens: scaleTokens, textStyle: textStyle })));
    return (react_1.default.createElement(react_native_1.View, { style: { width: '100%', marginBottom: scaleTokens.spacing.l } },
        react_1.default.createElement(react_native_1.View, { style: { overflow: 'hidden' } }, onPress ? (react_1.default.createElement(react_native_1.Pressable, { onPress: onPress, accessibilityLabel: accessibilityLabel, accessibilityRole: accessibilityRole, accessible: accessible, android_ripple: { color: `${theme.warningColor || '#F59E0B'}22` }, style: ({ pressed }) => [
            ...
            ] }, cardContent)) : (react_1.default.createElement(react_native_1.View, { style: [
                styles.card,
                {
                    padding: scaleTokens.spacing.xl,
                    borderRadius: scaleTokens.radius.s + 2,
